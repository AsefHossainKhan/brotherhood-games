...
export function ScoringPanel() {
  ...
  return (
    <div
      ...
      className="rounded-xl border border-yellow-500/30 bg-black/70 p-6 text-center backdrop-blur-md"
    >
      ...
      <div className="mb-4">
        ...
        <div
          className={`mt-1 text-lg font-bold ${bidSuccess ? "text-green-400" : "text-red-400"}`}
        >
      ...
      <Button onClick={startNextHand} data-testid="next-hand-btn" size="xl">
        Next Hand
      </Button>
    </div>
  );
