...
export function MatchCompletePanel() {
  ...
  return (
    <div
      ...
      className="rounded-xl border border-green-500/30 bg-black/70 p-8 text-center backdrop-blur-md"
    >
      ...
      {winner && (
        <div className="mb-6 text-3xl font-bold text-white">{winner} Wins!</div>
      )}
